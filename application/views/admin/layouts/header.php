    ...
    <aside id="a-sidebar" role="navigation" aria-label="Admin navigation">
        ...
        <nav class="a-nav">
            ...
            <a href="<?= base_url('admin/dashboard') ?>"
                class="a-link <?= (strpos($uri, 'dashboard') !== false || $uri === 'admin') ? 'on' : '' ?>">
                <i class="fa fa-home"></i> Dashboard
            </a>
            <a href="<?= base_url('admin/posts') ?>"
                class="a-link <?= strpos($uri, 'admin/posts') !== false ? 'on' : '' ?>">
                <i class="fa fa-film"></i> Posts &amp; Campaigns
            </a>
            <a href="<?= base_url('admin/services') ?>"
                class="a-link <?= strpos($uri, 'admin/services') !== false ? 'on' : '' ?>">
                <i class="fa fa-bolt"></i> Services
            </a>
            <a href="<?= base_url('admin/blogs') ?>"
                class="a-link <?= strpos($uri, 'admin/blogs') !== false ? 'on' : '' ?>">
                <i class="fa fa-pen-nib"></i> Blog Posts
            </a>
            ...
            <a href="<?= base_url('admin/settings') ?>"
                class="a-link <?= strpos($uri, 'settings') !== false ? 'on' : '' ?>">
                <i class="fa fa-cog"></i> Settings
            </a>
            <a href="<?= base_url() ?>" target="_blank" rel="noopener" class="a-link">
