...
/* ================================================================
   ...
   Immersive reading experience aligned with global dark theme
================================================================ */
.pd-hero {
    background: var(--s0);
    min-height: 70svh;
...
/* Content typography — Updated for dark mode */
.pd-content {
...
@media (max-width:960px) {
    ...
    .pd-sidebar {
        position: static;
        order: 2;
        /* Moves sidebar below content on mobile */
    }
    ...
    <div class="pd-layout">
        ...
        <aside class="pd-sidebar" aria-label="Post metadata">
            ...
            <div class="pd-sidebar-card rv sl d2">
                ...
                <p style="font-size:14px;color:var(--ghost4);line-height:1.78;margin-bottom:20px;">Ready to build
