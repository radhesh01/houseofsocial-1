...
================================================================ */
    ...
    @media (max-width:960px) {
        ...
        .bl-card-featured .bl-card-img::after {
            background: linear-gradient(to top, rgba(8, 8, 12, .95) 0%, transparent 60%);
        }
    }
...
<section class="bl-hero" aria-labelledby="bl-h1">
    ...
    <div class="bl-hero-content">
        <span class="s-label rv" style="margin-bottom:18px;color:var(--ghost4)">Insights &amp; Perspectives</span>
        <h1 id="bl-h1" class="bl-h1 rv d1">Our <em>Blog</em></h1>
        <p class="bl-hero-sub rv d2">Strategy, culture, creator economy, and digital marketing insights from the people
            who live online.</p>
    </div>
</section>
        ...
        <div class="bl-grid rv sc">
            <?php if (empty($blogs)): ?>
                <div class="bl-empty">
                    ...
                    <p style="font-size:14px;color:var(--ghost3)">We're writing something worth reading — check back soon.
                    </p>
                </div>
                <?php else:
                    ...
                    <?php if ($is_featured): ?>
                        <a href="<?= base_url('blog/' . $b['slug']) ?>" class="bl-card bl-card-featured">
                            <div class="bl-card-img">
                                <div
                                    style="width:100%;height:100%;background:var(--s2);display:flex;align-items:center;justify-content:center;position:absolute;inset:0">
                                    <span
                                        style="font-family:var(--fDisplay);font-size:60px;font-weight:700;color:var(--ghost2)">HOS</span>
                                </div>
                            </div>
