...
<style>
/* ================================================================
   POST DETAIL PAGE — same as post.php editorial style
================================================================ */
.pd-hero {
    background: var(--ink);
    min-height: 68vh;
        ...
        <div class="pd-hero-content">
            ...
            <div class="pd-meta">
                ...
                <a href="<?= htmlspecialchars($post['external_link']) ?>" target="_blank" rel="noopener"
                    style="font-family:var(--f-c);font-size:11px;letter-spacing:.12em;color:var(--amber);text-transform:uppercase;font-weight:700;">View
                    Campaign &#8599;</a>
                <?php endif; ?>
            </div>
