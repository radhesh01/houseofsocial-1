...
class Services extends CI_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->upload_path      = 'assets/images/uploads/services/';
        $this->upload_path_full = FCPATH . $this->upload_path;
        if (!is_dir($this->upload_path_full)) @mkdir($this->upload_path_full, 0755, TRUE);
    }
    ...
    {
        if (!isset($_FILES['icon_image']) || $_FILES['icon_image']['error'] === UPLOAD_ERR_NO_FILE) return '';
        ...
        if ($this->upload->do_upload('icon_image')) return $this->upload->data('file_name');
        return '';
    }
